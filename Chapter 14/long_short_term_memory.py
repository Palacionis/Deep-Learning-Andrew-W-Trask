# Chapter 14 - long short-term memory

# example of a vanishing gradient that prevents network from training:
import numpy as np
...
# example of exploding gradient that causes NaNs
...
# updated tensor deep neural network model from chapter 13 
...
# you can download the  data fromhttp://karpathy.github.io/2015/05/21/rnn-effectiveness/
# I had to save it as .rtf file and then use ░ textutil -convert txt shakespeare_data.rtf to convert it to .txt


f = open('/Users/jonas/Desktop/Books/Deep Learning - Andrew W Trask/Data/shakespeare_data.txt','r')
raw = f.read()
f.close()
...
# a function to generate sample text from what the network learned
...
print(generate_sample(n=3000, init_char='\n'))
